...
/**definizione della tipologia di veicoli di classe4*/
public class Classe4 implements Classe {
    private double costoKm;//attributo che definisce il costo da pagare al km della classe4

    public Classe4(){
        costoKm = 0.10;
    }
    /**metodo che consente di calcolare il costo del pedaggio (in base a quantikm ci sono da percorrere,
    passato come parametro) per i veicoli di classe4.
