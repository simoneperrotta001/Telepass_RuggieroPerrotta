...
/**definizione della tipologia di veicoli di classe5*/
public class Classe5 implements Classe {
    private double costoKm;//attributo che definisce il costo da pagare al km della classe5

    public Classe5(){
        costoKm = 0.11;
    }
    /**metodo che consente di calcolare il costo del pedaggio (in base a quantikm ci sono da percorrere,
    passato come parametro) per i veicoli di classe5.
    ...
    //metodo getter che restituisce la tariffa al km inerente alla classe3
